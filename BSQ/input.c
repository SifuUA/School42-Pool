...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/16 19:48:52 by oslutsky          #+#    #+#             */
/*   Updated: 2016/11/16 19:54:12 by oslutsky         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "inc.h"

int		write_to_temp_file(int fd)
{
	char	s1[BUFSIZE_STEP];
	int		nbytes;
	int		fd_temp;
	int		res;
	...
	else
	{
		...
		while (nbytes != 0)
		{
			nbytes = read(fd, s1, BUFSIZE_STEP);
